...
const ParametrosManager = (() => {
    ...
    let _dispersionState = (() => {
        ...
        } catch { return _defaultDispersionState(); }
    })();
    ...
    function setUmbralDispersion(statName, alerta, critico, enabled = true, columna = null) {
        ...
        if (!_dispersionState.columns) _dispersionState.columns = {};
        if (!_dispersionState.columns[key]) _dispersionState.columns[key] = {};
    ...
    function evaluarDispersion(statName, valor, columna = null) {
        ...
        if (!umbral || !umbral.enabled) return null;
