// ════════════════════════════════════════════════════════════════
// indexx-stats-core.js — Funciones estadísticas puras
// Extraído de EstadisticaDescriptiva.js — refactor 2026-07-19
// ════════════════════════════════════════════════════════════════
...
(function() {
    ...
    const calcularVarianza = Stats.calcularVarianza || (() => NaN);
    const calcularDesviacionEstandar = Stats.calcularDesviacionEstandar || (() => NaN);
    const calcularRango = Stats.calcularRango || (() => NaN);
    const calcularCoeficienteVariacion = Stats.calcularCoeficienteVariacion || (() => NaN);
    const calcularPercentil = Stats.calcularPercentil || (() => NaN);
    const calcularCuartiles = Stats.calcularCuartiles || (() => NaN);
    const calcularIQR = Stats.calcularIQR || (() => NaN);
    const calcularAsimetria = Stats.calcularAsimetria || (() => NaN);
    const calcularCurtosis = Stats.calcularCurtosis || (() => NaN);
    const calcularErrorEstandar = Stats.calcularErrorEstandar || (() => NaN);
