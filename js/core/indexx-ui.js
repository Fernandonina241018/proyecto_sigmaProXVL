...
var rightPanels = {
  ...
  firmarReporte: function() { return '<div class="page-body" style="display:flex;flex-direction:column;gap:12px;height:100%">' +
    '<div class="page-card" style="flex:1;display:flex;flex-direction:column;min-height:0">' +
      '<div class="page-card-header"><span class="page-card-icon">📄</span><span class="page-card-title">Vista previa del reporte</span><button onclick="firmaToggleFS()" style="margin-left:auto;padding:5px 13px;border-radius:5px;font-size:11px;font-weight:600;cursor:pointer;background:rgba(124,106,247,.12);color:#9d94f5;border:1.5px solid rgba(124,106,247,.35);font-family:inherit;transition:all .14s;display:flex;align-items:center;gap:4px" title="Pantalla completa" onmouseover="this.style.background=\'rgba(124,106,247,.22)\';this.style.color=\'#b0aaf7\'" onmouseout="this.style.background=\'rgba(124,106,247,.12)\';this.style.color=\'#9d94f5\'"><span style="font-size:18px">⛶</span></button>⛶</button></div>' +
